...
$(document).ready(function() {
    $('.block__title').click(function(event) {
        $('.block__item').toggleClass('back-white');
    });
});

$(document).ready(function() {
    $('.block__title2').click(function(event) {
        $('.block2').toggleClass('back-white');
    });
});
$(document).ready(function() {
    $('.block__title3').click(function(event) {
        $('.block3').toggleClass('back-white');
    });
});

$(document).ready(function() {
    $('.block__title4').click(function(event) {
        $('.block4').toggleClass('back-white');
    });
});
$(document).ready(function() {
    $('.block__title5').click(function(event) {
        $('.block5').toggleClass('back-white');
    });
});
...
/* $(document).ready(function() {
    setInterval(window.onload = function() {
        const main = document.querySelector('.third-right-side-box4')
        main.addEventListener('click', e => {
            const target = e.target
            if (target.classList.contains('case')) {
                target.classList.toggle('green-case2')
            }
        })
    });
}); */
